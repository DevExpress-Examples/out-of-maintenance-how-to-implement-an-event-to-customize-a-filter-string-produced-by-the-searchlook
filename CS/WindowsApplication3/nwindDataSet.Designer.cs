...
namespace DXSample {
    ...
    public partial class nwindDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomersDataTable : global::System.Data.DataTable, global::System.Collections.IEnumerable {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public CustomersRow AddCustomersRow(string CustomerID, string ContactName, string ContactTitle, string City, string Region) {
...
namespace DXSample.nwindDataSetTableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Customers` WHERE ((`CustomerID` = ?) AND ((? = 1 AND `ContactName` IS NULL) OR (`ContactName` = ?)) AND ((? = 1 AND `ContactTitle` IS NULL) OR (`ContactTitle` = ?)) AND ((? = 1 AND `City` IS NULL) OR (`City` = ?)) AND ((? = 1 AND `Region` IS NULL) OR (`Region` = ?)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Customers` SET `CustomerID` = ?, `ContactName` = ?, `ContactTitle` = ?, `City` = ?, `Region` = ? WHERE ((`CustomerID` = ?) AND ((? = 1 AND `ContactName` IS NULL) OR (`ContactName` = ?)) AND ((? = 1 AND `ContactTitle` IS NULL) OR (`ContactTitle` = ?)) AND ((? = 1 AND `City` IS NULL) OR (`City` = ?)) AND ((? = 1 AND `Region` IS NULL) OR (`Region` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CustomerID, ContactName, ContactTitle, City, Region FROM Customers";
        ...
        public virtual int Delete(string Original_CustomerID, string Original_ContactName, string Original_ContactTitle, string Original_City, string Original_Region) {
        ...
        public virtual int Update(string CustomerID, string ContactName, string ContactTitle, string City, string Region, string Original_CustomerID, string Original_ContactName, string Original_ContactTitle, string Original_City, string Original_Region) {
            if ((CustomerID == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ContactName, string ContactTitle, string City, string Region, string Original_CustomerID, string Original_ContactName, string Original_ContactTitle, string Original_City, string Original_Region) {
            return this.Update(Original_CustomerID, ContactName, ContactTitle, City, Region, Original_CustomerID, Original_ContactName, Original_ContactTitle, Original_City, Original_Region);
        }
    }
}
