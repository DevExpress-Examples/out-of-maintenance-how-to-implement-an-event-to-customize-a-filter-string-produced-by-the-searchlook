...
Namespace DXSample
	...
	Partial Public Class nwindDataSet
		...
		Partial Public Class CustomersDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Function AddCustomersRow(ByVal CustomerID As String, ByVal ContactName As String, ByVal ContactTitle As String, ByVal City As String, ByVal Region As String) As CustomersRow
				Dim rowCustomersRow As CustomersRow = (CType(Me.NewRow(), CustomersRow))
				Dim columnValuesArray() As Object = { CustomerID, ContactName, ContactTitle, City, Region}
...
Namespace DXSample.nwindDataSetTableAdapters
	...
	Partial Public Class CustomersTableAdapter
		...
		Private Sub InitAdapter()
			...
			Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Customers` WHERE ((`CustomerID` = ?) AND ((? = 1 AND `ContactName` IS NULL) OR (`ContactName` = ?)) AND ((? = 1 AND `ContactTitle` IS NULL) OR (`ContactTitle` = ?)) AND ((? = 1 AND `City` IS NULL) OR (`City` = ?)) AND ((? = 1 AND `Region` IS NULL) OR (`Region` = ?)))"
			...
			Me._adapter.UpdateCommand.CommandText = "UPDATE `Customers` SET `CustomerID` = ?, `ContactName` = ?, `ContactTitle` = ?, `City` = ?, `Region` = ? WHERE ((`CustomerID` = ?) AND ((? = 1 AND `ContactName` IS NULL) OR (`ContactName` = ?)) AND ((? = 1 AND `ContactTitle` IS NULL) OR (`ContactTitle` = ?)) AND ((? = 1 AND `City` IS NULL) OR (`City` = ?)) AND ((? = 1 AND `Region` IS NULL) OR (`Region` = ?)))"
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT CustomerID, ContactName, ContactTitle, City, Region FROM Customers"
		...
		Public Overridable Function Delete(ByVal Original_CustomerID As String, ByVal Original_ContactName As String, ByVal Original_ContactTitle As String, ByVal Original_City As String, ByVal Original_Region As String) As Integer
			...
			Else
				...
				Me.Adapter.DeleteCommand.Parameters(2).Value = (CStr(Original_ContactName))
			End If
			...
			Else
				...
				Me.Adapter.DeleteCommand.Parameters(4).Value = (CStr(Original_ContactTitle))
			End If
			...
			Else
				...
				Me.Adapter.DeleteCommand.Parameters(6).Value = (CStr(Original_City))
			End If
			...
			Else
				...
				Me.Adapter.DeleteCommand.Parameters(8).Value = (CStr(Original_Region))
			End If
		...
		Public Overridable Function Update(ByVal CustomerID As String, ByVal ContactName As String, ByVal ContactTitle As String, ByVal City As String, ByVal Region As String, ByVal Original_CustomerID As String, ByVal Original_ContactName As String, ByVal Original_ContactTitle As String, ByVal Original_City As String, ByVal Original_Region As String) As Integer
			...
			Else
				...
				Me.Adapter.UpdateCommand.Parameters(7).Value = (CStr(Original_ContactName))
			End If
			If (Original_ContactTitle Is Nothing) Then
			...
			Else
				...
				Me.Adapter.UpdateCommand.Parameters(9).Value = (CStr(Original_ContactTitle))
			End If
			If (Original_City Is Nothing) Then
			...
			Else
				...
				Me.Adapter.UpdateCommand.Parameters(11).Value = (CStr(Original_City))
			End If
			If (Original_Region Is Nothing) Then
			...
			Else
				...
				Me.Adapter.UpdateCommand.Parameters(13).Value = (CStr(Original_Region))
			End If
		...
		<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, True)> _
		Public Overridable Function Update(ByVal ContactName As String, ByVal ContactTitle As String, ByVal City As String, ByVal Region As String, ByVal Original_CustomerID As String, ByVal Original_ContactName As String, ByVal Original_ContactTitle As String, ByVal Original_City As String, ByVal Original_Region As String) As Integer
			Return Me.Update(Original_CustomerID, ContactName, ContactTitle, City, Region, Original_CustomerID, Original_ContactName, Original_ContactTitle, Original_City, Original_Region)
		End Function
	End Class
End Namespace
